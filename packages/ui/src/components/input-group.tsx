...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: This shared primitive mirrors shadcn input-group markup.
		<div
			className={cn(
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: This shared primitive groups inline input adornments.
		// biome-ignore lint/a11y/useKeyWithClickEvents: The click delegates focus to the sibling input, not a control action.
		// biome-ignore lint/a11y/noNoninteractiveElementInteractions: This adornment is non-interactive and only forwards focus.
		<div
